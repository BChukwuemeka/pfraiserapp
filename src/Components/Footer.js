...
const Footer = () => {
    return ( 
        ...
        <div className="footer-header">
            <h3 className="color2">People's Fund Raiser</h3>
        ...
        <div className="learn-more">
            ...
            <ul>
                <li>
                    <a href="">How SaveLives@Livestars Works</a>
                </li>
                <li>
...
<div className="copyright">
       <div>
           <p>Copyright &copy; <a href="#" target="_blank" title="PFRaiser Limited">people's fund raiser Limited</a> </p>
        </div>
